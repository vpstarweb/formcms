    ...
    content: `
      <div data-gjs-type="notification-bell"  class="relative inline-flex items-center mt-4 md:mt-0 ml-3">
        <button class="focus:outline-none hover:text-gray-900" data-component="notification-button">
          ...
          <span class="absolute -top-1 -right-1 bg-red-500 text-white text-xs font-bold rounded-full h-4 w-4 flex items-center justify-center" data-compoent="notification-count">3</span>
        </button>
      </div>
    `,
};