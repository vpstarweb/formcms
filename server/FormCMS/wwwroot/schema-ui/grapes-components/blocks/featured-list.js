...
<div class="py-6" data-gjs-type="data-list" data-component="data-list" offset="0" limit="5">
    <h3 class="sm:text-2xl text-2xl font-bold title-font mb-2 text-gray-900 dark:text-gray-100">Related List</h3>
    <div class="mt-4" data-gjs-type="foreach" data-component="foreach">
        <div class="lg:border-t5-100 max-md:border-t5-100 bg-white dark:bg-gray-800 p-3 rounded-lg shadow-sm hover:shadow-md transition-shadow duration-200 mb-2">
            <div class="flex items-start">
                <div class="w-16 h-16 shrink-0 mr-3">
                    <a href="/page/{{id}}" class="block">
                    <img src="{{image.url}}" class="w-full h-full object-cover rounded-md" />
                    </a>
                </div>
                <div class="flex-1">
                    <a href="/page/{{id}}"  class="block">
                        <h3 class="text-lg font-serif font-extrabold text-gray-800 dark:text-gray-200 hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors duration-200">{{title}}</h3>
                    </a>
                    <div class="flex items-center gap-2 text-xs text-gray-500 dark:text-gray-400 mt-2">
                        <button class="group cursor-pointer flex items-center gap-1 min-w-[50px] hover:text-indigo-500 dark:hover:text-indigo-400 transition-colors duration-200">
