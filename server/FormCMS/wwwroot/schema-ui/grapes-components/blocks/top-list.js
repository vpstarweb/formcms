            ...
            <div class="flex items-start">
                ...
                <div class="flex-1">
                    ...
                    <div class="flex items-center gap-2 text-xs text-gray-500 mt-2" data-component="activity-bar" data-gjs-type="activity-bar">
                        <button  data-component="share-button" class="group cursor-pointer flex items-center gap-1 min-w-[50px] hover:text-blue-500 transition-colors duration-200">
                        ...
                        <button  data-component="like-button" class="group cursor-pointer flex items-center gap-1 min-w-[50px] hover:text-blue-500 transition-colors duration-200">
